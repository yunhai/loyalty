...
--
-- Host: localhost:3306
-- Generation Time: Jul 07, 2019 at 01:43 AM
...
(2, 2, 3, '99999999999999', '9999999999', 4, 2),
...
(2, 17, '54', '2019-06-30 00:00:00', 7, 2),
(3, 17, '12', '2019-06-24 00:00:00', 7, 2),
(4, 17, '20', '2019-06-29 00:00:00', 2, 2),
(5, 17, '25', '2019-06-25 00:00:00', 7, 2),
(6, 17, '26', '2019-06-26 00:00:00', 7, 2),
(7, 17, '27', '2019-06-27 00:00:00', 7, 2),
(8, 17, '28', '2019-06-28 00:00:00', 7, 2),
(9, 17, '29', '2019-06-29 00:00:00', 7, 2),
(10, 17, '30', '2019-07-02 00:00:00', 7, 2);
...
(2, 17, '20', '2019-06-24 00:00:00', 2),
(3, 17, '25', '2019-06-25 00:00:00', 2),
(4, 17, '26', '2019-06-26 00:00:00', 2),
(5, 17, '27', '2019-06-27 00:00:00', 2),
(6, 17, '28', '2019-06-28 00:00:00', 2),
(7, 17, '29', '2019-06-29 00:00:00', 2);
...
CREATE TABLE `users` (
  ...
  `AnswerId` varchar(2048) NOT NULL,
  `CrUserId` int(11) NOT NULL,
  `CrDateTime` datetime NOT NULL,
  `UpdateUserId` int(11) DEFAULT NULL,
  `UpdateDateTime` datetime DEFAULT NULL
...
(1, 'admin', '25f9e794323b453885f5181f1b624d0b', 'Admin', 'haminhman2011@gmail.com', 1, 2, 1, '01669136318', 'logowt.png', 'e5ca59ae5994fc', 0, '0', 1, '2017-07-23 21:24:59', 3, '2018-07-22 19:34:27'),
...
(6, 'KH06', '25f9e794323b453885f5181f1b624d0b', 'nguyen van a', 'man001', 0, 2, 2, '038998998', NULL, NULL, 2, 'tao test', 1, '2019-06-17 20:00:32', NULL, NULL),
(7, 'KH07', 'cbfd88f83314ac9ef26faa0bdc5f007d', 'Hai Truong', 'yunhaihuang+06272314@gmail.com', 0, 2, 2, '0909682328', NULL, NULL, 2, 'tao test', 0, '2019-06-27 23:15:01', 1, '2019-07-07 01:36:25'),
(8, 'KH08', 'f584ce046d4271c1afbb6a3ad5ba8166', 'Ngo Hong Dao', 'yunhaihuang+06272316@gmail.com', 0, 2, 2, '909682329', NULL, NULL, 2, 'tao test', 0, '2019-06-27 23:16:31', 1, '2019-06-28 00:47:11'),
...
(10, 'KH10', '9acfa09324f99de3219edb0fe3031252', 'fullname', 'email@email.com', 1, 0, 2, '07070025', NULL, NULL, 2, 'reply', 1, '2019-07-07 00:33:05', NULL, NULL),
(11, '07070025', '9acfa09324f99de3219edb0fe3031252', 'fullname', 'email@email.com', 1, 0, 2, '07070025', NULL, NULL, 2, 'reply', 1, '2019-07-07 00:47:14', NULL, NULL),
(12, '1562435422', '9acfa09324f99de3219edb0fe3031252', 'fullname', '1562435422@email.com', 1, 0, 2, '1562435422', NULL, NULL, 2, 'reply', 1, '2019-07-07 00:50:22', NULL, NULL),
(13, '1562435460', '9acfa09324f99de3219edb0fe3031252', 'fullname', '1562435460@email.com', 1, 0, 2, '1562435460', NULL, NULL, 2, 'reply', 1, '2019-07-07 00:51:00', NULL, NULL);
...
--
ALTER TABLE `customersanticipates`
  MODIFY `CustomersAnticipateId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `lotteryresults`
  MODIFY `LotteryResultId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `playerwins`
  MODIFY `PlayerWinId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
