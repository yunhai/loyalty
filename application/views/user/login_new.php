...
<div class="login-box-body custom-ip">
    ...
    <?php echo form_open('api/user/admin_login', array('id' => 'userForm')); ?>
    <div class="input-field">
        <input type="text" class="material hmdrequired" name="UserName" value="<?php echo $userName; ?>" placeholder="Nhập username" data-field="Username"><span class="bottom"></span>
        <label><i class="ion-person"></i></label>
    </div>
    <div class="input-field">
        <input type="password" class="material hmdrequired" name="Password" placeholder="Nhập password" data-field="Password"><span class="bottom"></span>
    ...
    <?php echo form_close(); ?>
    <input type="hidden" id="dashboardUrl" value="<?php echo base_url('user/list'); ?>">
