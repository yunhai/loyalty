        ...
        <div class="container-fluid">
            <section class="content-header no-pd-lr">
                ...
                <ul class="list-inline new-stl">
                    <li><a href="<?php echo base_url('lotteryresult/add'); ?>"  class="btn btn-primary">Thêm</a></li>
                </ul>
            </section>
            <section class="content upn ft-seogeo">
                        ...
                        <div class="dropdown-menu mt10 pos-arrow-dropdown animate-scale-dropdown" role="menu">
                            <form class="form-inline">
                                <div class="form-group block-display widthauto">
                                    <button id="btn-filter" data-href="<?php echo base_url('lotteryresult/searchByFilter'); ?>" type="submit" data-toggle="dropdown" class="btn btn-default">Thêm điều kiện lọc</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="">
                    ...
                    <input type="hidden" id="urlEdit" value="<?= base_url('lotteryresult/edit') ?>">
                    <input type="hidden" id="urlDelete" value="<?= base_url('lotteryresult/delete') ?>">
